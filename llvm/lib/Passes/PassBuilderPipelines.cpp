...
#ifdef MOVIDIUS_PUSHBACK
static cl::opt<bool> EnableExtendTruncateReduction(
    "enable-extend-truncate-reduction", cl::init(false), cl::Hidden,
    cl::desc("Enable the ExtendTruncateReduction Pass"));
#endif // MOVIDIUS_PUSHBACK
...
#ifdef MOVIDIUS_PUSHBACK
  if (EnableExtendTruncateReduction)
    FPM.addPass(ExtendTruncateReduction());
#endif // MOVIDIUS_PUSHBACK
...
PassBuilder::buildLTODefaultPipeline(OptimizationLevel Level,
  ...
  if (EnableExtendTruncateReduction)
    MPM.addPass(createModuleToFunctionPassAdaptor(
        ExtendTruncateReduction(), PTO.EagerlyInvalidateAnalyses));
#endif // MOVIDIUS_PUSHBACK
